...
# (3) Import it into k3s
sudo k3s ctr images import credit-check-service-part3.tar
...
sed -i "s/{{addhost}}/$HOSTNAME/" part3/creditcheckservice-solutions-part3.yaml
#deploy the pod from credicheckservice-solutions.yaml 
kubectl apply -f part3/creditcheckservice-solutions-part3.yaml
